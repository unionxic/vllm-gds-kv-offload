...
class EngineArgs:
    ...
    offload_ssd_path: str | None = PrefetchOffloadConfig.offload_ssd_path
    offload_host_fraction: float = PrefetchOffloadConfig.offload_host_fraction
    offload_ssd_transport: str = PrefetchOffloadConfig.offload_ssd_transport
    offload_ssd_io_threads: int = PrefetchOffloadConfig.offload_ssd_io_threads
    offload_ssd_ring_mb: int = PrefetchOffloadConfig.offload_ssd_ring_mb
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        offload_group.add_argument(
            "--offload-ssd-path", **prefetch_kwargs["offload_ssd_path"]
        )
        offload_group.add_argument(
            "--offload-host-fraction", **prefetch_kwargs["offload_host_fraction"]
        )
        offload_group.add_argument(
            "--offload-ssd-transport", **prefetch_kwargs["offload_ssd_transport"]
        )
        offload_group.add_argument(
            "--offload-ssd-io-threads", **prefetch_kwargs["offload_ssd_io_threads"]
        )
        offload_group.add_argument(
            "--offload-ssd-ring-mb", **prefetch_kwargs["offload_ssd_ring_mb"]
        )
    ...
    def create_engine_config(
        ...
        offload_config = OffloadConfig(
            ...
            prefetch=PrefetchOffloadConfig(
                ...
                offload_ssd_path=self.offload_ssd_path,
                offload_host_fraction=self.offload_host_fraction,
                offload_ssd_transport=self.offload_ssd_transport,
                offload_ssd_io_threads=self.offload_ssd_io_threads,
                offload_ssd_ring_mb=self.offload_ssd_ring_mb,
            ),
        )
