...
3-2. 설정 차이를 표에 적는다. 기본값에서 손댄 항목(게이트, cuFile 조각, KV 예산, 상주 layer, gpu_util, 폴링 양보)을 런마다 명시한다. 기본값 런과 손본 런의 차이가 결과의 일부다(66B RAM 0.5에서 20%).
